...
public class ContentControlle extends AbstractController<Content, ContentService> {
    ...
    public Object add(Content entity) {
        BaseResult result = BaseResult.success();
        try {
            entity.setCategoryId(entity.getContentCategory().getId());
    ...
    public Object update(Content entity) {
        ...
        try {
            ...
            result = BaseResult.failed("修改内容失败");
        }
        return result;
    }
